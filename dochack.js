...
var NTI486539820 = {size: 0, kind: 24, base: null, node: null, finalizer: null};
...
function addChars_251658415(result_251658417, result_251658417_Idx, x_251658418, start_251658419, n_251658420) {
    ...
    Label1: do {
      ...
      Label2: do {
          Label3: while (true) {
          if (!(i_486539337 < n_251658420)) break Label3;
            iHEX60gensym4_251658435 = i_486539337;
            result_251658417[result_251658417_Idx][chckIndx(addInt(old_251658421, iHEX60gensym4_251658435), 0, (result_251658417[result_251658417_Idx]).length - 1)] = x_251658418.charCodeAt(chckIndx(addInt(start_251658419, iHEX60gensym4_251658435), 0, (x_251658418).length - 1));
            i_486539337 = addInt(i_486539337, 1);
          }
      } while (false);
    } while (false);
...
function HEX3Aanonymous_486539300(event_486539301) {
                event_486539301.target.parentNode.style.display = "none";
                event_486539301.target.parentNode.nextSibling.style.display = "inline";

              
            }

    document.getElementById("theme-select").value = window.localStorage.getItem("theme");
    var pragmaDots_486539290 = document.getElementsByClassName("pragmadots");
    Label1: do {
      var i_486539299 = 0;
      var colontmp__486539330 = 0;
      colontmp__486539330 = (pragmaDots_486539290).length;
      var i_486539331 = 0;
      Label2: do {
          Label3: while (true) {
          if (!(i_486539331 < colontmp__486539330)) break Label3;
            i_486539299 = i_486539331;
            pragmaDots_486539290[chckIndx(i_486539299, 0, (pragmaDots_486539290).length - 1)].onclick = HEX3Aanonymous_486539300;
...
var alternative_486539904 = [null];

function isWhitespace_486539628(text_486539629) {
         return !/[^\s]/.test(text_486539629);
  

  
}

function isWhitespace_486539631(x_486539632) {
    var Temporary1;
    var Temporary2;

  var result_486539633 = false;

    if (!(x_486539632.nodeName == "#text")) Temporary2 = false; else {      Temporary2 = isWhitespace_486539628(x_486539632.textContent);    }    if (Temporary2) Temporary1 = true; else {      Temporary1 = (x_486539632.nodeName == "#comment");    }    result_486539633 = Temporary1;

  return result_486539633;

}

function toToc_486539634(x_486539635, father_486539636) {
                var Temporary5;
            var Temporary6;
            var Temporary7;
            var Temporary8;
    ...
    if ((x_486539635.nodeName == "UL")) {
    var f_486539644 = {heading: null, kids: [], sortId: (father_486539636.kids).length, doSort: false};
    var i_486539645 = 0;
    Label1: do {
        Label2: while (true) {
        if (!(i_486539645 < x_486539635.childNodes.length)) break Label2;
          var nxt_486539646 = addInt(i_486539645, 1);
          Label3: do {
              Label4: while (true) {
                if (!(nxt_486539646 < x_486539635.childNodes.length)) Temporary5 = false; else {                  Temporary5 = isWhitespace_486539631(x_486539635.childNodes[nxt_486539646]);                }              if (!Temporary5) break Label4;
                nxt_486539646 = addInt(nxt_486539646, 1);
              }
          } while (false);
            if (!(nxt_486539646 < x_486539635.childNodes.length)) Temporary8 = false; else {              Temporary8 = (x_486539635.childNodes[i_486539645].nodeName == "LI");            }            if (!Temporary8) Temporary7 = false; else {              Temporary7 = (x_486539635.childNodes[i_486539645].childNodes.length == 1);            }            if (!Temporary7) Temporary6 = false; else {              Temporary6 = (x_486539635.childNodes[nxt_486539646].nodeName == "UL");            }          if (Temporary6) {
          var e_486539658 = {heading: x_486539635.childNodes[i_486539645].childNodes[0], kids: [], sortId: (f_486539644.kids).length, doSort: false};
          var it_486539659 = x_486539635.childNodes[nxt_486539646];
          Label9: do {
            var j_486539664 = 0;
            var colontmp__486539942 = 0;
            colontmp__486539942 = it_486539659.childNodes.length;
            var i_486539943 = 0;
            Label10: do {
                Label11: while (true) {
                if (!(i_486539943 < colontmp__486539942)) break Label11;
                  j_486539664 = i_486539943;
                  toToc_486539634(it_486539659.childNodes[j_486539664], e_486539658);
                  i_486539943 = addInt(i_486539943, 1);
                }
            } while (false);
          } while (false);
          f_486539644.kids.push(e_486539658);;
          i_486539645 = addInt(nxt_486539646, 1);
          }
          else {
            toToc_486539634(x_486539635.childNodes[i_486539645], f_486539644);
            i_486539645 = addInt(i_486539645, 1);
          }
          
        }
    } while (false);
    father_486539636.kids.push(f_486539644);;
    }
    else {
    if (isWhitespace_486539631(x_486539635)) {
    }
    else {
    if ((x_486539635.nodeName == "LI")) {
    var idx_486539681 = [];
    Label12: do {
      var i_486539686 = 0;
      var colontmp__486539946 = 0;
      colontmp__486539946 = x_486539635.childNodes.length;
      var i_486539947 = 0;
      Label13: do {
          Label14: while (true) {
          if (!(i_486539947 < colontmp__486539946)) break Label14;
            i_486539686 = i_486539947;
            if (!(isWhitespace_486539631(x_486539635.childNodes[i_486539686]))) {
            idx_486539681.push(i_486539686);;
            }
      ...
      if (!((idx_486539681).length == 2)) Temporary15 = false; else {        Temporary15 = (x_486539635.childNodes[idx_486539681[chckIndx(1, 0, (idx_486539681).length - 1)]].nodeName == "UL");      }    if (Temporary15) {
    var e_486539702 = {heading: x_486539635.childNodes[idx_486539681[chckIndx(0, 0, (idx_486539681).length - 1)]], kids: [], sortId: (father_486539636.kids).length, doSort: false};
    var it_486539703 = x_486539635.childNodes[idx_486539681[chckIndx(1, 0, (idx_486539681).length - 1)]];
    Label16: do {
      var j_486539708 = 0;
      var colontmp__486539950 = 0;
      colontmp__486539950 = it_486539703.childNodes.length;
      var i_486539951 = 0;
      Label17: do {
          Label18: while (true) {
          if (!(i_486539951 < colontmp__486539950)) break Label18;
            j_486539708 = i_486539951;
            toToc_486539634(it_486539703.childNodes[j_486539708], e_486539702);
            i_486539951 = addInt(i_486539951, 1);
          }
      } while (false);
    } while (false);
    father_486539636.kids.push(e_486539702);;
    }
    else {
      Label19: do {
        var i_486539717 = 0;
        var colontmp__486539954 = 0;
        colontmp__486539954 = x_486539635.childNodes.length;
        var i_486539955 = 0;
        Label20: do {
            Label21: while (true) {
            if (!(i_486539955 < colontmp__486539954)) break Label21;
              i_486539717 = i_486539955;
              toToc_486539634(x_486539635.childNodes[i_486539717], father_486539636);
    ...
    father_486539636.kids.push({heading: x_486539635, kids: [], sortId: (father_486539636.kids).length, doSort: false});;
    }
    }}
...
function extractItems_486539454(x_486539455, heading_486539456, items_486539457, items_486539457_Idx) {
      var Temporary1;
  ...
  BeforeRet: do {
    ...
    break BeforeRet;
      ...
      if (!!((x_486539455.heading == null))) Temporary1 = false; else {        Temporary1 = (x_486539455.heading.textContent == heading_486539456);      }    if (Temporary1) {
    Label2: do {
      var i_486539474 = 0;
      var colontmp__486539958 = 0;
      colontmp__486539958 = (x_486539455.kids).length;
      var i_486539959 = 0;
      Label3: do {
          Label4: while (true) {
          if (!(i_486539959 < colontmp__486539958)) break Label4;
            i_486539474 = i_486539959;
            items_486539457[items_486539457_Idx].push(x_486539455.kids[chckIndx(i_486539474, 0, (x_486539455.kids).length - 1)].heading);;
      ...
      Label5: do {
        ...
        colontmp__486539962 = (x_486539455.kids).length;
        var i_486539963 = 0;
        Label6: do {
            Label7: while (true) {
            if (!(i_486539963 < colontmp__486539962)) break Label7;
              i_486539486 = i_486539963;
              var it_486539487 = x_486539455.kids[chckIndx(i_486539486, 0, (x_486539455.kids).length - 1)];
              extractItems_486539454(it_486539487, heading_486539456, items_486539457, items_486539457_Idx);
...
function tree_486539345(tag_486539346, kids_486539347) {
  var result_486539348 = null;

    result_486539348 = document.createElement(toJSStr(tag_486539346));
    Label1: do {
      var k_486539361 = null;
      var i_486539976 = 0;
      Label2: do {
          Label3: while (true) {
          if (!(i_486539976 < (kids_486539347).length)) break Label3;
            k_486539361 = kids_486539347[chckIndx(i_486539976, 0, (kids_486539347).length - 1)];
            result_486539348.appendChild(k_486539361);
            i_486539976 = addInt(i_486539976, 1);
          }
      } while (false);
    } while (false);

  return result_486539348;

}

function text_486539381(s_486539382) {
  var result_486539383 = null;

    result_486539383 = document.createTextNode(s_486539382);

  return result_486539383;
...
function uncovered_486539783(x_486539784) {
      var Temporary1;
    var Temporary2;
  ...
  BeforeRet: do {
      if (!((x_486539784.kids).length == 0)) Temporary1 = false; else {        Temporary1 = !((x_486539784.heading == null));      }    if (Temporary1) {
    if (!(x_486539784.heading.hasOwnProperty('__karaxMarker__'))) {
    Temporary2 = x_486539784;
    }
    else {
    Temporary2 = null;
    }
    
    result_486539785 = Temporary2;
    break BeforeRet;
    }
    
    result_486539785 = {heading: x_486539784.heading, kids: [], sortId: x_486539784.sortId, doSort: x_486539784.doSort};
    Label3: do {
      var i_486539804 = 0;
      var colontmp__486539983 = 0;
      colontmp__486539983 = (x_486539784.kids).length;
      var i_486539984 = 0;
      Label4: do {
          Label5: while (true) {
          if (!(i_486539984 < colontmp__486539983)) break Label5;
            i_486539804 = i_486539984;
            var y_486539805 = uncovered_486539783(x_486539784.kids[chckIndx(i_486539804, 0, (x_486539784.kids).length - 1)]);
            if (!((y_486539805 == null))) {
            result_486539785.kids.push(y_486539805);;
            }
    ...
    if (((result_486539785.kids).length == 0)) {
    result_486539785 = null;
    }
...
function mergeTocs_486539817(orig_486539818, news_486539819) {
  var result_486539820 = null;

    result_486539820 = uncovered_486539783(orig_486539818);
    if ((result_486539820 == null)) {
    result_486539820 = news_486539819;
    }
    else {
      Label1: do {
        var i_486539832 = 0;
        var colontmp__486539979 = 0;
        colontmp__486539979 = (news_486539819.kids).length;
        var i_486539980 = 0;
        Label2: do {
            Label3: while (true) {
            if (!(i_486539980 < colontmp__486539979)) break Label3;
              i_486539832 = i_486539980;
              result_486539820.kids.push(news_486539819.kids[chckIndx(i_486539832, 0, (news_486539819.kids).length - 1)]);;
  ...
  return result_486539820;

}

function buildToc_486539837(orig_486539838, types_486539839, procs_486539840) {
                      var Temporary7;

  var result_486539841 = null;

    var newStuff_486539846 = {heading: null, kids: [], doSort: true, sortId: 0};
    Label1: do {
      var t_486539867 = null;
      var i_486539971 = 0;
      var L_486539972 = (types_486539839).length;
      Label2: do {
          Label3: while (true) {
          if (!(i_486539971 < L_486539972)) break Label3;
            t_486539867 = types_486539839[chckIndx(i_486539971, 0, (types_486539839).length - 1)];
            var c_486539872 = {heading: t_486539867.cloneNode(true), kids: [], doSort: true, sortId: 0};
            t_486539867.__karaxMarker__ = true;
            Label4: do {
              var p_486539876 = null;
              var i_486539968 = 0;
              var L_486539969 = (procs_486539840).length;
              Label5: do {
                  Label6: while (true) {
                  if (!(i_486539968 < L_486539969)) break Label6;
                    p_486539876 = procs_486539840[chckIndx(i_486539968, 0, (procs_486539840).length - 1)];
                    if (!(p_486539876.hasOwnProperty('__karaxMarker__'))) {
                    var xx_486539877 = p_486539876.parentNode.getElementsByClassName("attachedType");
                      if (!((xx_486539877).length == 1)) Temporary7 = false; else {                        Temporary7 = (xx_486539877[chckIndx(0, 0, (xx_486539877).length - 1)].textContent == t_486539867.textContent);                      }                    if (Temporary7) {
                    var q_486539882 = tree_486539345(makeNimstrLit("A"), [text_486539381(p_486539876.title)]);
                    q_486539882.setAttribute("href", p_486539876.getAttribute("href"));
                    c_486539872.kids.push({heading: q_486539882, kids: [], sortId: 0, doSort: false});;
                    p_486539876.__karaxMarker__ = true;
                    }
                    
                    }
                    
                    i_486539968 = addInt(i_486539968, 1);
                    if (!(((procs_486539840).length == L_486539969))) {
            ...
            newStuff_486539846.kids.push(c_486539872);;
            i_486539971 = addInt(i_486539971, 1);
            if (!(((types_486539839).length == L_486539972))) {
            failedAssertImpl_218103864(makeNimstrLit("iterators.nim(243, 11) `len(a) == L` the length of the seq changed while iterating over it"));
            }
    ...
    result_486539841 = mergeTocs_486539817(orig_486539838, newStuff_486539846);

  return result_486539841;

}

function add_486539371(parent_486539372, kid_486539373) {
      var Temporary1;
        var Temporary2;

      if (!(parent_486539372.nodeName == "TR")) Temporary1 = false; else {        if ((kid_486539373.nodeName == "TD")) Temporary2 = true; else {          Temporary2 = (kid_486539373.nodeName == "TH");        }        Temporary1 = Temporary2;      }    if (Temporary1) {
    var k_486539374 = document.createElement("TD");
    k_486539374.appendChild(kid_486539373);
    parent_486539372.appendChild(k_486539374);
    }
    else {
    parent_486539372.appendChild(kid_486539373);
    }
...
function setClass_486539375(e_486539376, value_486539377) {
    e_486539376.setAttribute("class", toJSStr(value_486539377));

  
}

function toHtml_486539497(x_486539498, isRoot_486539499) {
      var Temporary1;
    
function HEX3Aanonymous_486539517(a_486539518, b_486539519) {
          var Temporary1;

      var result_486539520 = 0;

      BeforeRet: do {
          if (!!((a_486539518.heading == null))) Temporary1 = false; else {            Temporary1 = !((b_486539519.heading == null));          }        if (Temporary1) {
        var x_486539529 = a_486539518.heading.textContent;
        var y_486539530 = b_486539519.heading.textContent;
        if ((x_486539529 < y_486539530)) {
        result_486539520 = -1;
        break BeforeRet;
        }
        
        if ((y_486539530 < x_486539529)) {
        result_486539520 = 1;
        break BeforeRet;
        }
        ...
        break BeforeRet;
          ...
          result_486539520 = subInt(a_486539518.sortId, b_486539519.sortId);
          break BeforeRet;
        }
  ...
  var result_486539500 = null;

  BeforeRet: do {
    if ((x_486539498 == null)) {
    result_486539500 = null;
    break BeforeRet;
    }
    
    if (((x_486539498.kids).length == 0)) {
    if ((x_486539498.heading == null)) {
    result_486539500 = null;
    break BeforeRet;
    }
    
    result_486539500 = x_486539498.heading.cloneNode(true);
    break BeforeRet;
    }
    
    result_486539500 = tree_486539345(makeNimstrLit("DIV"), []);
      if (!!((x_486539498.heading == null))) Temporary1 = false; else {        Temporary1 = !(x_486539498.heading.hasOwnProperty('__karaxMarker__'));      }    if (Temporary1) {
    add_486539371(result_486539500, x_486539498.heading.cloneNode(true));
    }
    
    var ul_486539516 = tree_486539345(makeNimstrLit("UL"), []);
    if (isRoot_486539499) {
    setClass_486539375(ul_486539516, makeNimstrLit("simple simple-toc"));
    }
    else {
    setClass_486539375(ul_486539516, makeNimstrLit("simple"));
    }
    
    if (x_486539498.doSort) {
    x_486539498.kids.sort(HEX3Aanonymous_486539517);
    }
    
    Label2: do {
      var k_486539559 = null;
      var i_486539988 = 0;
      var L_486539989 = (x_486539498.kids).length;
      Label3: do {
          Label4: while (true) {
          if (!(i_486539988 < L_486539989)) break Label4;
            k_486539559 = x_486539498.kids[chckIndx(i_486539988, 0, (x_486539498.kids).length - 1)];
            var y_486539560 = toHtml_486539497(k_486539559, false);
            if (!((y_486539560 == null))) {
            add_486539371(ul_486539516, tree_486539345(makeNimstrLit("LI"), [y_486539560]));
            }
            
            i_486539988 = addInt(i_486539988, 1);
            if (!(((x_486539498.kids).length == L_486539989))) {
            failedAssertImpl_218103864(makeNimstrLit("iterators.nim(243, 11) `len(a) == L` the length of the seq changed while iterating over it"));
            }
    ...
    if (!((ul_486539516.childNodes.length == 0))) {
    add_486539371(result_486539500, ul_486539516);
    }
    
    if ((result_486539500.childNodes.length == 0)) {
    result_486539500 = null;
    }
    
  } while (false);

  return result_486539500;

}

function replaceById_486539386(id_486539387, newTree_486539388) {
    var x_486539389 = document.getElementById(id_486539387);
    x_486539389.parentNode.replaceChild(newTree_486539388, x_486539389);
    newTree_486539388.id = id_486539387;

  
}

function togglevis_486539905(d_486539906) {
        if (d_486539906.style.display == 'none')
      d_486539906.style.display = 'inline';
    else
      d_486539906.style.display = 'none';
  

  
}

function groupBy(value_486539908) {
    var toc_486539909 = document.getElementById("toc-list");
    if ((alternative_486539904[0] == null)) {
    var tt_486539917 = {heading: null, kids: [], sortId: 0, doSort: false};
    toToc_486539634(toc_486539909, tt_486539917);
    tt_486539917 = tt_486539917.kids[chckIndx(0, 0, (tt_486539917.kids).length - 1)];
    var types_486539922 = [[]];
    var procs_486539927 = [[]];
    extractItems_486539454(tt_486539917, "Types", types_486539922, 0);
    extractItems_486539454(tt_486539917, "Procs", procs_486539927, 0);
    extractItems_486539454(tt_486539917, "Converters", procs_486539927, 0);
    extractItems_486539454(tt_486539917, "Methods", procs_486539927, 0);
    extractItems_486539454(tt_486539917, "Templates", procs_486539927, 0);
    extractItems_486539454(tt_486539917, "Macros", procs_486539927, 0);
    extractItems_486539454(tt_486539917, "Iterators", procs_486539927, 0);
    var ntoc_486539928 = buildToc_486539837(tt_486539917, types_486539922[0], procs_486539927[0]);
    var x_486539929 = toHtml_486539497(ntoc_486539928, true);
    alternative_486539904[0] = tree_486539345(makeNimstrLit("DIV"), [x_486539929]);
    }
    
    if ((value_486539908 == "type")) {
    replaceById_486539386("tocRoot", alternative_486539904[0]);
    }
    else {
    replaceById_486539386("tocRoot", tree_486539345(makeNimstrLit("DIV"), []));
    }
    
    togglevis_486539905(document.getElementById("toc-list"));

  
}
var db_486539991 = [[]];
var contents_486539992 = [[]];
var oldtoc_486540157 = [null];
var timer_486540158 = [null];
...
function fuzzyMatch_637534224(pattern_637534225, str_637534226) {
  ...
  var result_637534229 = {Field0: 0, Field1: false};
    ...
    var colontmp__486540218 = nimMax(0, score_637534236);
    var colontmp__486540219 = (0 < score_637534236);
    result_637534229 = nimCopy(result_637534229, {Field0: colontmp__486540218, Field1: colontmp__486540219}, NTI637534222);
...
function escapeCString_486539995(x_486539996, x_486539996_Idx) {
    ...
    Label1: do {
      var c_486539998 = 0;
      var iHEX60gensym6_486540222 = 0;
      var nHEX60gensym6_486540223 = ((x_486539996[x_486539996_Idx]) == null ? 0 : (x_486539996[x_486539996_Idx]).length);
      Label2: do {
          Label3: while (true) {
          if (!(iHEX60gensym6_486540222 < nHEX60gensym6_486540223)) break Label3;
            c_486539998 = x_486539996[x_486539996_Idx].charCodeAt(chckIndx(iHEX60gensym6_486540222, 0, (x_486539996[x_486539996_Idx]).length - 1));
            switch (c_486539998) {
            case 60:
            ...
            iHEX60gensym6_486540222 = addInt(iHEX60gensym6_486540222, 1);
          }
      } while (false);
    } while (false);
...
function text_486539378(s_486539379) {
  var result_486539380 = null;

    result_486539380 = document.createTextNode(toJSStr(s_486539379));

  return result_486539380;
...
function HEX3Aanonymous_486540056(a_486540061, b_486540062) {
  ...
  var result_486540001 = null;
    ...
    contents_486539992[0] = nimCopy(null, [], NTI486539820);
    Label1: do {
      var ahref_486540030 = null;
      var i_486540203 = 0;
      var L_486540204 = (db_486539991[0]).length;
      Label2: do {
          Label3: while (true) {
          if (!(i_486540203 < L_486540204)) break Label3;
            ahref_486540030 = db_486539991[0][chckIndx(i_486540203, 0, (db_486539991[0]).length - 1)];
            contents_486539992[0].push(ahref_486540030.getAttribute("data-doc-search-tag"));;
            i_486540203 = addInt(i_486540203, 1);
            if (!(((db_486539991[0]).length == L_486540204))) {
            failedAssertImpl_218103864(makeNimstrLit("iterators.nim(243, 11) `len(a) == L` the length of the seq changed while iterating over it"));
            }
    ...
    var ul_486540035 = tree_486539345(makeNimstrLit("UL"), []);
    result_486540001 = tree_486539345(makeNimstrLit("DIV"), []);
    setClass_486539375(result_486540001, makeNimstrLit("search_results"));
    var matches_486540040 = [];
    Label4: do {
      var i_486540048 = 0;
      var colontmp__486540208 = 0;
      colontmp__486540208 = (db_486539991[0]).length;
      var i_486540209 = 0;
      Label5: do {
          Label6: while (true) {
          if (!(i_486540209 < colontmp__486540208)) break Label6;
            i_486540048 = i_486540209;
            Label7: do {
              ...
              var colontmp__486540215 = fuzzyMatch_637534224(value_486540000, c_486540049);
              var score_486540050 = colontmp__486540215["Field0"];
              var matched_486540051 = colontmp__486540215["Field1"];
            ...
            i_486540209 = addInt(i_486540209, 1);
          }
      } while (false);
    } while (false);
    ...
    Label8: do {
      var i_486540084 = 0;
      var colontmp__486540212 = 0;
      colontmp__486540212 = nimMin((matches_486540040).length, 29);
      var i_486540213 = 0;
      Label9: do {
          Label10: while (true) {
          if (!(i_486540213 < colontmp__486540212)) break Label10;
            i_486540084 = i_486540213;
            ...
            add_486539371(ul_486540035, tree_486539345(makeNimstrLit("LI"), [matches_486540040[chckIndx(i_486540084, 0, (matches_486540040).length - 1)]["Field0"]]));
            i_486540213 = addInt(i_486540213, 1);
          }
      } while (false);
    } while (false);
    if ((ul_486540035.childNodes.length == 0)) {
    add_486539371(result_486540001, tree_486539345(makeNimstrLit("B"), [text_486539378(makeNimstrLit("no search results"))]));
    }
    else {
      add_486539371(result_486540001, tree_486539345(makeNimstrLit("B"), [text_486539378(makeNimstrLit("search results"))]));
      add_486539371(result_486540001, ul_486540035);
    }
...
function wrapper_486540169() {
        var elem_486540170 = document.getElementById("searchInput");
        var value_486540171 = elem_486540170.value;
        if (!((((value_486540171) == null ? 0 : (value_486540171).length) == 0))) {
        if ((oldtoc_486540157[0] == null)) {
        oldtoc_486540157[0] = document.getElementById("tocRoot");
        }
        
        var results_486540175 = dosearch_486539999(value_486540171);
        replaceById_486539386("tocRoot", results_486540175);
        }
        else {
        if (!((oldtoc_486540157[0] == null))) {
        replaceById_486539386("tocRoot", oldtoc_486540157[0]);
        }
        }
    ...
    if (!((timer_486540158[0] == null))) {
    clearTimeout(timer_486540158[0]);
    }
    
    timer_486540158[0] = setTimeout(wrapper_486540169, 400);
