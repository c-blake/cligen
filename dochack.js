...
function toJSStr(s_p0) {
  var result_33556891 = null;
    ...
    var res_33556943 = newSeq__system_u2487((s_p0).length);
    var i_33556944 = 0;
    var j_33556945 = 0;
    Label1: {
        Label2: while (true) {
        if (!(i_33556944 < (s_p0).length)) break Label2;
          var c_33556946 = s_p0[i_33556944];
          if ((c_33556946 < 128)) {
          res_33556943[j_33556945] = String.fromCharCode(c_33556946);
          i_33556944 += 1;
          }
          else {
            var helper_33556969 = newSeq__system_u2487(0);
            Label3: {
                Label4: while (true) {
                if (!true) break Label4;
                  var code_33556970 = c_33556946.toString(16);
                  if ((((code_33556970) == null ? 0 : (code_33556970).length) == 1)) {
                  helper_33556969.push("%0");;
                  }
                  else {
                  helper_33556969.push("%");;
                  }
                  
                  helper_33556969.push(code_33556970);;
                  i_33556944 += 1;
                  if ((((s_p0).length <= i_33556944) || (s_p0[i_33556944] < 128))) {
                  break Label3;
                  }
                  
                  c_33556946 = s_p0[i_33556944];
                }
            };
++excHandler;
            try {
            res_33556943[j_33556945] = decodeURIComponent(helper_33556969.join(""));
--excHandler;
} catch (EXCEPTION) {
 var prevJSError = lastJSError;
 lastJSError = EXCEPTION;
 --excHandler;
            res_33556943[j_33556945] = helper_33556969.join("");
    ...
    result_33556891 = res_33556943.join("");
...
function chckRange(i_p0, a_p1, b_p2) {
  var result_33557331 = 0;

  BeforeRet: {
    if (((a_p1 <= i_p0) && (i_p0 <= b_p2))) {
    result_33557331 = i_p0;
    break BeforeRet;
    }
    else {
    raiseRangeError();
...
function nimCopy(dest_p0, src_p1, ti_p2) {
  var result_33557291 = null;
    ...
    case 23:
    case 5:
      if (!(isFatPointer__system_u2839(ti_p2))) {
      result_33557291 = src_p1;
      }
      else {
        result_33557291 = [src_p1[0], src_p1[1]];
      }
    ...
    case 19:
      ...
      result_33557291 = dest_p0;
    
      break;
    case 18:
    case 17:
      if (!((ti_p2.base == null))) {
      result_33557291 = nimCopy(dest_p0, src_p1, ti_p2.base);
      }
      else {
      if ((ti_p2.kind == 17)) {
      result_33557291 = (dest_p0 === null || dest_p0 === undefined) ? {m_type: ti_p2} : dest_p0;
      }
      else {
        result_33557291 = (dest_p0 === null || dest_p0 === undefined) ? {} : dest_p0;
      }
      }
      nimCopyAux(result_33557291, src_p1, ti_p2.node);
      break;
    case 4:
    case 16:
        ...
        if (src_p1 === null) {
          ...
          for (var i = 0; i < src_p1.length; ++i) {
            result_33557291[i] = nimCopy(result_33557291[i], src_p1[i], ti_p2.base);
          }
        }
      }
    ...
    case 28:
            if (src_p1 !== null) {
        result_33557291 = src_p1.slice(0);
      }
  ...
  return result_33557291;

}

function chckIndx(i_p0, a_p1, b_p2) {
  var result_33557326 = 0;

  BeforeRet: {
    if (((a_p1 <= i_p0) && (i_p0 <= b_p2))) {
    result_33557326 = i_p0;
    break BeforeRet;
    }
    else {
...
function newSeq__system_u2487(len_p0) {
  var result_33556922 = [];

    result_33556922 = new Array(len_p0); for (var i = 0 ; i < len_p0 ; ++i) { result_33556922[i] = null; }
...
function isFatPointer__system_u2839(ti_p0) {
  var result_33557273 = false;

  BeforeRet: {
    result_33557273 = !((ConstSet1[ti_p0.base.kind] != undefined));
    break BeforeRet;
  };

  return result_33557273;
